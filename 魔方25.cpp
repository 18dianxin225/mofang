...
{
printf('The Colors of Up:');
printsurface(m.up);
printf('The Colors of Down:');
printsurface(m.down);
printf('The Colors of Front:');
printsurface(m.front);
printf('The Colors of Back:');
printsurface(m.back);
printf('The Colors of Left:');
printsurface(m.left);
printf('The Colors of Right:');
